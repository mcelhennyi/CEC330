...
webtalk_add_data -client project -key cpu_speed -value "3198 MHz" -context "user_environment"
webtalk_add_data -client project -key total_processors -value "1" -context "user_environment"
webtalk_add_data -client project -key system_ram -value "8.000 GB" -context "user_environment"
webtalk_add_data -client project -key os_name -value "Microsoft Windows 8 or later , 64-bit" -context "user_environment"
webtalk_add_data -client project -key os_release -value "major release  (build 9200)" -context "user_environment"
...
webtalk_add_data -client labtool -key chain -value "13631093" -context "labtool\\usage"
webtalk_add_data -client labtool -key pgmcnt -value "03:00:00" -context "labtool\\usage"
webtalk_transmit -clientid 918796658 -regid "211068406_0_0_244" -xml F:/CEC330/Lab_6/Lab_6.hw/webtalk/usage_statistics_ext_labtool.xml -html F:/CEC330/Lab_6/Lab_6.hw/webtalk/usage_statistics_ext_labtool.html -wdm F:/CEC330/Lab_6/Lab_6.hw/webtalk/usage_statistics_ext_labtool.wdm -intro "<H3>LABTOOL Usage Report</H3><BR>"
=======
...
>>>>>>> 6c9fb1f675bb8e70e05afbf7600cd26d73edadc7
webtalk_terminate
