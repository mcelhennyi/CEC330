...
HD_PWD='F:/CEC330/Final_Project_accel_2/Final_Project_accel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Final_top.tcl -notrace
